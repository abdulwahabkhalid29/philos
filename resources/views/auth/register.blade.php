                ...
                <div class="cart-widget-product ">
                    ...
                    <ul class="cart-product-item">
                        ...
                        <li>
                            <!--Item Image-->
                            <a href="#" class="product-image">
                                <img src="{{asset('assets/img/product-img/small/product_12547555.jpgg')}} alt="" /></a>
                        ...
                        <div class="col-md-6">
                            <div class="form-border-box">
                                <form  method="POST" action="{{ route('register') }}">
                                    ...
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror input-md form-full-width" placeholder="Enter Your Email Name" name="name" value="{{ old('name') }}" required autocomplete="name" size="30" autofocus>
                                    @error('name')
                                    ...
                                    <div class="form-field-wrapper mt-4">
                                    <input id="email" type="text" class="form-control @error('email') is-invalid @enderror input-md form-full-width" placeholder="Enter Your Email Email" name="email" value="{{ old('email') }}" required autocomplete="name" size="30" autofocus>
                                    @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="form-field-wrapper mt-4">
                                    <input id="password" type="password" class="form-control @error('password') is-invalid @enderror input-md form-full-width" placeholder="Enter Your Password" name="password" value="{{ old('password') }}" required autocomplete="name" size="30" autofocus>
                                    @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                    ...
                                    <div class="form-field-wrapper mt-4">
                                    <input id="password-confirm" type="password" class="form-control input-md form-full-width" placeholder="Confirm Password" name="password_confirmation" required autocomplete="new-password" >
                                    </div>
                                    <a href="{{route('login')}}">Already have an account</a>
                                    <div class="form-field-wrapper mt-4">
                                        <input name="submit" id="submit" class="submit btn btn-md btn-black" value="Registered" type="submit">
                                    </div>
                                </form>
                            </div>
                        </div>
