                    ...
                    <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display: none;" data-version="5.3.0.2">
                        <ul>
                            <li class="dark-bg" data-index="rs-1" data-transition="random" data-slotamount="7" data-masterspeed="500" data-thumb="" data-saveperformance="off" data-title="01">
                                <!-- Main Image Layer 0-->
                                <img src="{{asset('assets/img/slide-img/slide_bg1.jpg')}}" alt="h" title="home-1-slide-1" width="1920" height="1100" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina />
                            ...
                            <li data-index="rs-2" data-transition="random" data-slotamount="7" data-masterspeed="500" data-thumb="" data-saveperformance="off" data-title="02">
                                <!-- Main Image Layer 0-->
                                <img src="{{asset('assets/img/slide-img/slide_bg2.jpg')}}" alt="h" title="home-1-slide-1" width="1920" height="1100" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina />
                                <!-- LAYERS -->
                            ...
                            <li data-index="rs-3" data-transition="random" data-slotamount="7" data-masterspeed="500" data-thumb="" data-saveperformance="off" data-title="03">
                                <!-- Main Image Layer 0-->
                                <img src="{{asset('assets/img/slide-img/slide_bg3.jpg')}}" alt="h" title="home-1-slide-1" width="1920" height="1100" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="6" class="rev-slidebg" data-no-retina />
                                <!-- LAYERS -->
                                ...
                                <div class="tp-caption NotGeneric-Title tp-resizeme" style="letter-spacing: 0px; line-height: 60px;"
                                    ...
                                    <img src="{{asset('assets/img/slider-caption-sale.png')}}" alt="" style="width: 100%; max-width: 682px;" />
                                </div>
                            ...
                            <div id="new-product" class="product-item-4 owl-carousel owl-theme nf-carousel-theme1">
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470001.jpg')}}" alt="">
                                        </div>
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        ...
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470002.jpg')}}" alt="">
                                        </div>
                                        <div class="product-button">
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470003.jpg')}}" alt="">
                                        </div>
                                        <div class="product-button">
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        ...
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470004.jpg')}}" alt="">
                                        </div>
                                        <div class="product-button">
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470005.jpg')}}" alt="">
                                        </div>
                                        <div class="product-button">
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470006.jpg')}}" alt="">
                                        </div>
                                        <div class="product-button">
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                                ...
                                <div class="product-item">
                                    <div class="product-item-inner">
                                        <div class="product-img-wrap">
                                            <img src="{{asset('assets/img/product-img/big/product_125470007.jpg')}}" alt="">
                                        </div>
                                        <div class="product-button">
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Cart"><i class="fa fa-shopping-bag"></i></a>
                                            <a href="#" class="js_tooltip" data-mode="top" data-tip="Add To Whishlist"><i class="fa fa-heart"></i></a>
                ...
                <div class="container container-margin-minus-t">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="categories-box">
                                <div class="categories-image-wrap">
                                    <img src="{{asset('assets/img/categories/Categories_cupple.jpg')}}" alt="" />
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="categories-box">
                                <div class="categories-image-wrap">
                                    <img src="{{asset('assets/img/categories/Categories_women.jpg')}}" alt="" />
                                </div>
                                <div class="categories-content">
                                    <a href="#">
                                        <div class="categories-caption">
                        ...
                        <div class="col-md-4">
                            <div class="categories-box">
                                <div class="categories-image-wrap">
                                    <img src="{{asset('assets/img/categories/Categories_man.jpg')}}" alt="" />
                                </div>
                                <div class="categories-content">
                                    <a href="#">
                                        <div class="categories-caption">
                ...
                <div class="container">
                    <div id="blog-carousel" class="blog-carousel owl-carousel owl-theme nf-carousel-theme1">
                        ...
                        <div class="product-item">
                            <div class="blog-box">
                                <div class="blog-img-wrap">
                                    <img src="{{asset('assets/img/blog/blog_01.jpg')}}" alt="philos" />
                                </div>
                        ...
                        <div class="product-item">
                            <div class="blog-box">
                                <div class="blog-img-wrap">
                                    <img src="{{asset('assets/img/blog/blog_02.jpg')}}" alt="theme" />
                                </div>
                                <div class="blog-box-content">
                                    <div class="blog-box-content-inner">
                        ...
                        <div class="product-item">
                            <div class="blog-box">
                                <div class="blog-img-wrap">
                                    <img src="{{asset('assets/img/blog/blog_03.jpg')}}" alt="template" />
                                </div>
                                <div class="blog-box-content">
                                    <div class="blog-box-content-inner">
                ...
                <div class="container">
                    <ul class="list-none-ib brand-logo-carousel owl-carousel owl-theme">
                        <li class="brand-item"><a href="#">
                            <img src="{{asset('assets/img/logo/01.png')}}" alt="nileforest" />
                        </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/02.png')}}" alt="niletheme" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/03.png')}}" alt="nile" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/04.png')}}" alt="forest" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/05.png')}}" alt="themeforest" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/06.png')}}" alt="woocommerce" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/07.png')}}" alt="ecommerce" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/08.png')}}" alt="html" />
                            </a>
                        </li>
                        <li class="brand-item">
                            <a href="#">
                                <img src="{{asset('assets/img/logo/09.png')}}" alt="multiprapose" />
                            </a>
                        </li>
